...
def iniciar_ordenamiento():
    ...
    if algoritmo_ordenamiento.get() == 'Ordenamiento Burbuja':
        ...
        algoritmos.ordenamiento_rapido(conjunto_datos, 0, len(conjunto_datos) - 1, dibujar_datos,
                                       velocidad_animacion.get())
...
Label(marco_lateral, text="Algoritmos de Ordenamiento", bg='#ECF2FF', font=('consolas', 12, "bold")).grid(row=0,
                                                                                                          column=0,
                                                                                                          padx=5,
                                                                                                          pady=5)
...
Label(marco_lateral, text="Algoritmos de Búsqueda", bg='#ECF2FF', font=('consolas', 12, "bold")).grid(row=2, column=0,
                                                                                                      padx=5, pady=5)
...
Label(marco_lateral, text="---------O---------", bg='#ECF2FF', font=('consolas', 10, "bold")).grid(row=16, column=0,
                                                                                                   padx=5, pady=5)
Label(marco_lateral, text="Ingrese números (,)", bg='#ECF2FF', font=('consolas', 10, "bold")).grid(row=17, column=0,
                                                                                                   padx=5, pady=5)
